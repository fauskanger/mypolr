...
project = 'mypolr'
copyright = '2017, Thomas Fauskanger'
...
latex_documents = [
    (master_doc, 'mypolr.tex', 'mypolr Documentation',
     'Thomas Fauskanger', 'manual'),
]
...
man_pages = [
    (master_doc, 'mypolr', 'mypolr Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'mypolr', 'mypolr Documentation',
     author, 'mypolr', 'One line description of project.',
     'Miscellaneous'),
]
